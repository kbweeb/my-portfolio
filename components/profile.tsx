      ...
      <div className="grid md:grid-cols-4 gap-12">
        ...
        <div className="md:col-span-1 space-y-4">
          ...
          <div className="pt-8 border-t border-border">
            ...
            <div className="flex gap-3">
              ...
              <a
                href="mailto:kbweeb.01@gmail.com"
                className="p-2 bg-secondary rounded-lg hover:bg-primary/20 hover:text-primary transition-colors"
                aria-label="Email"
              >
        ...
        <div className="md:col-span-3 space-y-8 animate-slide-up">
          <div className="space-y-3">
            <h1 className="text-4xl md:text-5xl font-bold">Kwabena Boateng</h1>
            <p className="text-xl text-primary font-semibold">Computer Engineering Student</p>
          </div>
